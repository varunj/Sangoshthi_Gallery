...
import io.gihub.varunj.sangoshthi_gallery.synclibrary.Progress;
...
public class TaskAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.fragment_sync_task, parent, false);
    ...
    private static class ViewHolder {
        ...
        ProgressBar pb;
        ImageButton startBtn, stopBtn, deleteBtn;
        ...
        public ViewHolder(View rootView) {
            ...
            startBtn = (ImageButton) rootView.findViewById(R.id.start);
            stopBtn = (ImageButton) rootView.findViewById(R.id.stop);
            deleteBtn = (ImageButton) rootView.findViewById(R.id.delete);
        }
    }
}
